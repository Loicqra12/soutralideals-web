...
import { MapSection } from "@/components/shared/LeafletMap";
import { SimilarPrestataires } from "@/components/prestataires/SimilarPrestataires";
import {
  getCategoryLabel,
  getEntityServiceId,
  getPrestatairePhone,
...
export default function PrestataireDetailClient({
  params,
}: {
        ...
        <div className="mx-auto max-w-5xl px-4 py-8 lg:px-8">
          ...
          <div className="mt-8 grid gap-8 lg:grid-cols-3">
            ...
            >
              ...
              <MapSection
                geoloc={prestataire.geoloc}
                label={name}
                address={ville ?? prestataire.localisation}
              />
            </motion.div>
